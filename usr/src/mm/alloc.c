...
#define first_fit 0		/* parameter for alloc_mem from do_worst_fit */
#define worst_fit 1		/* parameter for alloc_mem from do_worst_fit */
...
PRIVATE int memoryAlgorithm = first_fit; /* ancillary variable to choose memory allocation algorithm */
